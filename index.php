...
<head>
  ...
  <title>Uptraining & Consulting Academy - Accueil</title>
...
<body>
    ...
    <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/slide-2.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Vous accompagner vers la réussite</h2>
              <p class="animate__animated animate__fadeInUp" style="font-size:18px ;">Nous utilisons la formation comme un levier d'accompagnement du changement</p>
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">DÉCOUVRIR NOTRE CATALOGUE DE FORMATIONS</a>
            </div>
          </div>
        </div>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row content">
          ...
          <p style="font-size: 16px;"><a href=""> <b>Plus . . </b> </a></p>
        </div>
          </div>
 ...
 <section id="services" class="services">
    ...
    <section id="services" class="services">
      ...
      <div class="row justify-content-center m-3">
          <p style="font-size: 16px;"><a href=""> <b>Voir plus </b> </a></p>
        </div>
    ...
    <section id="team" class="team ">
      <div class="container">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              ...
              <div class="member-info">
                <h4> CHAWKI NACERA</h4>
                <span>CEO – Consultante/formatrice</span>
        ...
        <div class="row justify-content-center m-3">
          <p style="font-size: 16px;"><a href="team.php"> <b>Voir plus </b> </a></p>
        </div>
