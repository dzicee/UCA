...
<head>
  ...
  <title>Contact - Uptraining & Consulting Academy</title>
...
<!-- End Header -->
  ...
  <main id="main">
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Adresse :</h4>
                <p>29 Adam Street, Alger, Algerie</p>
              </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form  method="post" action="" role="form" class="php-email-form">
              ...
              <div class="form-group">
                <input type="text" class="form-control" name="subject" id="subject" placeholder="Objet" data-rule="minlen:4" data-msg="Entrer l'objet svp !" />
                <div class="validate"></div>
              </div>
              <div class="form-group">
    ...
    if (isset($_POST['message'])) {
        $retour = mail('ou.abdelatif@gmail.com', 'Envoi depuis la page Contact du site web', $_POST['message'], 'From: webmaster@monsite.fr' . "\r\n" . 'Reply-to: ' . $_POST['email']);
        if($retour)
